...
public class teacherProfile extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
                        ...
                        if (task.isSuccessful()) {
                            ...
                            if (document != null && document.exists()) {
                                ...
                                if (profileImageUrl != null && !profileImageUrl.isEmpty()) {
                                    ...
                                    Toast.makeText(teacherProfile.this, "No profile photo found", Toast.LENGTH_SHORT).show();
                                }
                            } else {
                                Toast.makeText(teacherProfile.this, "User document not found", Toast.LENGTH_SHORT).show();
                            }
        ...
        select.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                ImagePicker.with(teacherProfile.this)
                                    ...
                                    fStore.collection("Users")
                                            ...
                                            .addOnSuccessListener(new OnSuccessListener<Void>() {
                                                ...
                                                public void onSuccess(Void unused) {
                                                    Toast.makeText(teacherProfile.this, "Profile picture uploaded successfully", Toast.LENGTH_SHORT).show();
                                                }
                                            }).addOnFailureListener(e -> {
                                                // Handle unsuccessful uploads
                                                Toast.makeText(teacherProfile.this, "Failed to upload profile picture", Toast.LENGTH_SHORT).show();
                                            });
